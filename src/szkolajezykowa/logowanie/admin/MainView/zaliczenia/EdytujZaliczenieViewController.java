...
public class EdytujZaliczenieViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(szkolajezykowa.logowanie.admin.MainView.zaliczenia.EdytujZaliczenieViewController.class.getName()).log(Level.SEVERE, null, ex);
        }
...
"FROM kursanci,kurskursanci,kurs WHERE kurs.id_kursu=" + idKursu + " AND kurs.id_kursu=kurskursanci.id_kursu AND kurskursanci.id_kursanta=kursanci.id_kursanta");
    ...
    private void dodajZaliczenie(ActionEvent event) throws IOException, SQLException {
        ...
        if (add){
            ...
            cst.setString(4, cbTyp.getSelectionModel().getSelectedItem().toString());
