 ...
 * @author BlackHawk
 */
public class WykladowcyDetails {
    ...
    public WykladowcyDetails(int id_wykladowcy, String imie, String nazwisko, String email, String telefon, String jezyk, String login, String haslo) {
